...
from ultralytics.ultralytics.nn.tasks import attempt_load_weights
...
def get_params():
    params = {
        'weight': 'runs/train/yolov9-c/exp-yolov9-c-DilatedReparamNCSPNCSPELAN4/weights/best.pt', # 只需要指定权重即可
        'device': 'cuda:0',
        'layer': '10', # string
        'dataset': 'data/VOCdevkit-youzi/VOC2007/train.txt',
        'num_images': 50,
