...
def parse_opt(known=False):
    ...
    parser.add_argument('--project', default=ROOT / 'runs/train/yolov9-c', help='save to project/name')
    parser.add_argument('--name', default='exp-yolov9-c', help='save to project/name')
