...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    # Optimizer
    nbs = 64 if 'exp' not in opt.cfg else batch_size # nominal batch size
...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='yolov9-c-expab.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/2025-01-24_5-Fold_Cross-val/split_1/split_1_dataset.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--project', default=ROOT / 'runs/pear/5_Flod', help='save to project/name')
    parser.add_argument('--name', default='exp-ab', help='save to project/name')
